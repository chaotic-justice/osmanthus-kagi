...
export const Works: CollectionConfig<'works'> = {
  ...
  // This config controls what's populated by default when a work is referenced
  // https://payloadcms.com/docs/queries/select#defaultpopulate-collection-config-property
  // Type safe if the collection slug generic is passed to `CollectionConfig` - `CollectionConfig<'works'>
  defaultPopulate: {
    title: true,
    slug: true,
    categories: true,
